...
unsigned short sum_AVX(long size, unsigned short *a) {
	...
	return extracted_partial_sums[0] + extracted_partial_sums[1] + extracted_partial_sums[2] + extracted_partial_sums[3] +
           extracted_partial_sums[4] + extracted_partial_sums[5] + extracted_partial_sums[6] + extracted_partial_sums[7] +
           extracted_partial_sums[8] + extracted_partial_sums[9] + extracted_partial_sums[10]+ extracted_partial_sums[11]+
           extracted_partial_sums[12]+ extracted_partial_sums[13]+ extracted_partial_sums[14]+ extracted_partial_sums[15];
}
